    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="all-form-element-inner">
                <form action="<?php echo base_url()?>data_master/create_distrik_proses" method="post">
                 ...
                 <div class="form-group-inner">
                  <div class="row">
                      ...
                      <div class="col-lg-9">
                        <input type="text" name="kadis" class="form-control">
                      </div>
                  </div>
                </div>
                <div class="form-group-inner">
                 <div class="row">
                     ...
                     <div class="col-lg-9">
                       <input type="text" name="sekdis" class="form-control">
                     </div>
                 </div>
               </div>
               <div class="form-group-inner">
